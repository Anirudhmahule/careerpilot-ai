      ...
      <div className="mt-4 grid grid-cols-12 gap-4">
          ...
          <div className="flex items-start justify-between">
            <div>
              ...
              <div className="text-xs text-muted-foreground">
                Last 12 weeks · Senior Frontend Eng.
              </div>
            </div>
        ...
        <section className="col-span-12 rounded-xl border border-border bg-card p-5 shadow-xs xl:col-span-4">
          ...
          <ul className="mt-3 space-y-2">
            {[
              {
                t: "Read: 'Designing data-intensive apps' ch.4",
                d: "30m · System design",
                done: true,
              },
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  <div
                    className={
                      "truncate text-sm " + (t.done ? "text-muted-foreground line-through" : "")
                    }
                  >
                    {t.t}
                  </div>
        ...
        <section className="col-span-12 rounded-xl border border-border bg-card p-5 shadow-xs lg:col-span-7">
          <div className="flex items-center justify-between">
            ...
            <Link to="/app/roadmap" className="text-xs text-primary hover:underline">
              View roadmap
            </Link>
          </div>
              ...
              <div key={s.n} className="grid grid-cols-12 items-center gap-3">
                ...
                <div className="col-span-5 flex items-center gap-3">
                  <div className="h-1.5 flex-1 overflow-hidden rounded-full bg-border">
                    <div
                      className={
                        "h-full rounded-full " + (s.pct === 100 ? "bg-success" : "bg-primary")
                      }
                      style={{ width: `${s.pct}%` }}
                    />
                  </div>
        ...
        <section className="col-span-12 rounded-xl border border-border bg-card p-5 shadow-xs lg:col-span-5">
          <div className="flex items-center justify-between">
            ...
            <Link to="/app/insights" className="text-xs text-primary hover:underline">
              All gaps
            </Link>
          </div>
  ...
  return (
    <div className="rounded-xl border border-border bg-card p-5 shadow-xs">
      <div className="flex items-center justify-between text-xs text-muted-foreground">
        <span>{label}</span>
        <span className={(good ? "text-success" : "text-destructive") + " text-[11px] font-medium"}>
          {delta}
        </span>
      </div>
